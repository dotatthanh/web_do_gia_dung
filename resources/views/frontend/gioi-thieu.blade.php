...
@section('content')
    ...
    <div class="section" id="detail-blog-wp">
        ...
        <div class="section-detail">
            <div class="detail">
                <p>Cửa hàng đồ thể thao được thành lập tháng 6 năm 2021,
                    là cửa hàng chuyên buôn bán các sản phẩm
                    chất lượng chính hãng và các phụ kiện chuyên dụng
                    cho các sản phẩm giầy thể thao …
                </p>

                <p>Huỳnh Thiên luôn tập trung xây dựng dịch vụ khách hàng khác
                    biệt với chất lượng vượt trội, phù hợp với văn hoá, đặt khách hàng
                    làm trung tâm trong mọi suy nghĩ và hành động của cửa hàng. Huỳnh Thiên
                ...
                <p>Sự tin tưởng và ủng hộ của khách hàng trong suốt thời gian qua là
                    nguồn động viên to lớn trên bước đường phát triển của Huỳnh Thiên. Chúng
